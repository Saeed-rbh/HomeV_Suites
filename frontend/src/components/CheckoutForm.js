  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="rounded-[28px] bg-white border border-slate-100 shadow-[0_4px_30px_rgba(12,25,41,0.03)] p-3 sm:p-5 w-full">
          <div className="mb-4 flex items-center justify-between rounded-[20px] border border-slate-200 bg-slate-50 px-3 sm:px-4 py-3">
